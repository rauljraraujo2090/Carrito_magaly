                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="simpleinput">Apellidos y Nombres</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingrese su Apellido y Nombre">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingrese su numero de telefono">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Direccion</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingrese su direccion">
                                        </div>
